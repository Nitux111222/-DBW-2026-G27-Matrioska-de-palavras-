      ...
      <section id="modes" className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card
  className="hover:border-blue-400 transition-colors overflow-hidden group cursor-pointer"
...
>
            ...
            <Card
  className="hover:border-amber-400 transition-colors overflow-hidden group cursor-pointer"
  onClick={handleMultiplayer}
>
